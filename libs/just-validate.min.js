...
function(e) {
    ...
    f.prototype = {
        ...
        defaultMessages: { required: "Поле обязательное для ввода", email: "Please, type a valid email", maxLength: "Введите не более 30 символов", minLength: "Минимальное колличество символов: 2", password: "Password is not valid", remote: "Email already exists", strength: "Password must contents at least one uppercase letter, one lowercase letter and one number", "function": "Function returned false" },
